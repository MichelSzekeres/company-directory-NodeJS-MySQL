Step 1. file update only applies if you have full admin access to your database otherwise you may use your Cpanel/AWS/Azur panel to create the database
